...
import { MenuItem, InputLabel, FormControl, Select, FormGroup, Typography, Checkbox, Grid } from '@material-ui/core';
...
export const DynamicFormComponent = () => {
  ...
  const data = {
    "form": {
      "sections": [
        {
          "order": 1,
          "section_tile": "Basic information",
          "type": "ansible",
          "endpoint_url": "myurl", 
          "variables":{
            "version": "1.1.2",
  ...
  return (
      ...
      <Grid item>
        ...
        <input type="text" name="name_product" required={true} />
        <label>Produto type</label>
        <input type="text" name="type_product" required={true} />
        <label>Produto endpoint URL</label>
